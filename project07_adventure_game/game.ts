...
type gameState = "start" | "chooseDoor" | "roundTwo" | "roundThree" | "exit" | void | number | string;
...
async function chooseDoor(): Promise<gameState> {
...
async function roundTwo(): Promise<gameState> {
...
async function choosePathRoundTwo(): Promise<string> {
...
async function roundThree(): Promise<string> {
...
async function chooseRoomRoundThree(): Promise<string> {
